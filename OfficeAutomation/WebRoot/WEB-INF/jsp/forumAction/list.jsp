...
<body>
	<div id="Title_bar">
		<div id="Title_bar_Head">
			...
			<div id="Title">
				<!--页面标题-->
				<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif" /> 论坛
			</div>
							...
							<tr height="78" align="center" class="template">
								...
								<td class="ForumPageTableDataLine">
									<ul class="ForumPageTopicUl">
										<li class="ForumPageTopic"><s:a action="forumAction_show?id=%{id}" cssClass="ForumPageTopic">${name}</s:a></li>
								...
								<td class="ForumPageTableDataLine">
									<ul class="ForumPageTopicUl">
										<li><font color="#444444">┌ 主题：</font> <s:a cssClass="ForumTitle" action="topicAction_show?id=%{lastTopic.id}">${lastTopic.title}</s:a>
										</li>
