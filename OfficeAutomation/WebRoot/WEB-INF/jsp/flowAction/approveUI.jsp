        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="flowAction_download?applicationId=%{applicationId}" style="text-decoration: underline">[点击下载申请的文档]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>请选择下一步</td>
                        <td><s:select name="outcome" list="#outcomes"/></td>
                    </tr>
                    </s:if>
